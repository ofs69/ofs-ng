...
void generate(const std::vector<Entry> &entries, const std::string &outHeader, const std::string &outSource) {
    ...
    // ---- Header ----
    {
        std::ostringstream h;
        h << "#pragma once\n";
        h << "// AUTO-GENERATED by localization_gen. DO NOT EDIT. Source: tools/localization/strings.toml\n";
    ...
    {
        std::ostringstream c;
        c << "// AUTO-GENERATED by localization_gen. DO NOT EDIT. Source: tools/localization/strings.toml\n\n";
