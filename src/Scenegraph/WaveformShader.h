...
// Upper bound on the per-fragment min/max scan in the waveform shader (see WaveformShader.cpp). The
// renderer sizes the sample stride so a bar's whole bucket range is covered within this many samples,
